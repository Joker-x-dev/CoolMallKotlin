...
object GoodsCategoryRoutes {
     ...
     * 带参数的路由模式
     */
    const val GOODS_CATEGORY_PATTERN =
        "${GoodsRoutes.CATEGORY}?$GOODS_TYPE_ID_ARG={$GOODS_TYPE_ID_ARG}&$GOODS_FEATURED_ARG={$GOODS_FEATURED_ARG}&$GOODS_RECOMMEND_ARG={$GOODS_RECOMMEND_ARG}&$GOODS_KEYWORD_ARG={$GOODS_KEYWORD_ARG}"
}
